...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">BIBLIOTECA UNAPEC</a>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer bg-primary">
                    ...
                    <a href="https://www.instagram.com/Unapec/" class="text-danger"><i class="fab fa-instagram-square"></i> Instagram</a>
                </div>
            </nav>
        </div>